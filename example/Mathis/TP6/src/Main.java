...
public class Main {
    ...
    public static void main(String[] args) throws IOException{
        var laserDisc = new Articles.LaserDisc("Jaws");
        ...
        catalog4.add(new Articles.LaserDisc("A Fistful of something"));
        catalog4.add(new VideoTape("For a Few is More", Duration.ofMinutes(132)));





        catalog4.save(Path.of("catalog-windows-1252.txt"));

        var catalog5 = new Catalog();

        Catalog.load(Path.of("catalog-windows-1252.txt"), Charset.forName("Windows-1252"));



        System.out.println(catalog5.lookup("A Fistful of something"));
        System.out.println(catalog5.lookup("For a Few is More"));
